...
class VggUnet:
	...
	def getVggUnetModel(self, layersNotTrain, inputImgSize, nClasses,loadWeights):
		model = keras_segmentation.models.unet.vgg_unet(n_classes=nClasses ,  input_height=inputImgSize[0], input_width=inputImgSize[1])
		...
		model = models.model_utils.get_segmentation_model(model.input, o)
